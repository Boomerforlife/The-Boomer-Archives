export const mockPosts = [
  {
    id: '1',
    title: 'The Weight of Vellum: Studies in Surface Resistance',
  ...
  {
    id: '2',
    title: 'Preserving the Haptic Memory of Italian Leather',
  ...
  {
    id: '3',
    title: 'The Percussive Rhythm of the Hermes 3000',
    excerpt: 'Analyzing the haptic response and acoustic signature of Swiss-engineered manual typewriters.',
  ...
  {
    id: '4',
    title: 'Linen-Bound Memories from the Southern Coast',
    excerpt: 'A collection of botanical sketches preserved in hand-woven indigo linen covers.',
...
export const mockComments = [
  {
    ...
    author: 'Eleanor Ames',
    initials: 'EA',
    content: 'This piece resonates deeply. I find myself returning to my typewriter for first drafts precisely because of that "radical resistance" you mentioned.',
    date: '2 days ago'
  },
  {
    id: '2',
    author: 'Marcus Webb',
    initials: 'MW',
    content: 'The "dim mode" concept is brilliant. I\'ve started dimming my study lights to match the tone of my books, and it has completely changed my nighttime reading habit.',
    date: 'Yesterday'
  }
];
