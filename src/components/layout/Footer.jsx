    ...
    <footer className="bg-surface-dim w-full py-12 border-t border-outline-variant/10 mt-20">
      <div className="flex flex-col items-center gap-4 w-full text-center">
        <div className="flex gap-8">
          <Link to="/legal" className="text-xs font-sans tracking-wide text-on-surface-variant hover:text-on-surface transition-colors">
            Privacy
          </Link>
          <Link to="/legal" className="text-xs font-sans tracking-wide text-on-surface-variant hover:text-on-surface transition-colors">
            Terms
          </Link>
          <Link to="/colophon" className="text-xs font-sans tracking-wide text-on-surface-variant hover:text-on-surface transition-colors underline decoration-1 underline-offset-4">
            Colophon
          </Link>
        </div>
